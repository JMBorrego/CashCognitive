...
Los resultados del Causal Tree presentan unos valores de CATE relativamente similares a los obtenidos mediante el análisis propuesto con ITEs. A pesar de esto, cuando se incluyen todas las variables, no solamente las individuales, parece que el Causal Tree no da tanta importancia a las variables de comunidad. En este caso, variables como la edad del padre o el % de gasto en comida (propfood_05) explican mejor las diferencias de CATEs entr grupos.
